...
function HeroEditor({ data, onChange }) {
  ...
  return (
    <Card>
      ...
      <Input label="Accent Word" value={h.accent} onChange={(v) => upd("accent", v)} />
    ...
    <Card>
      ...
      {devs.map((d, i) => (
        <div key={i} style={{ border: "1px solid var(--gray-100)", borderRadius: 12, marginBottom: 10, overflow: "hidden" }}>
          <div
            style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 18px", cursor: "pointer", background: expand === i ? "var(--off)" : "#fff", transition: "background .15s" }}
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: "var(--gray-400)" }}>{d.role} · {d.rate}</div>
            </div>
...
// Only tabs that have real working editors.
// group: "HOME" = home-page sections, "PAGES" = other page editors.
const TABS = [
...
export default function AdminDashboard({ onLogout }) {
  ...
  // Safe fallback — never undefined, so currentTab.label never crashes
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--off, #f0f4ff)", fontFamily: "var(--font-body)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <button
            ...
            style={{ display: "none", width: 36, height: 36, border: "1.5px solid var(--gray-100)", borderRadius: 8, background: "var(--off)", cursor: "pointer", alignItems: "center", justifyContent: "center" }}
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <button
            ...
            style={{ width: 34, height: 34, border: "1.5px solid var(--gray-100)", borderRadius: 8, background: "var(--off)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
            title="Logout"
          >
          ...
          <aside className={`admin-sidebar${sideOpen ? " mobile-open" : ""}`}>
              ...
              {["HOME", "PAGES"].map((group) => (
                <div key={group}>
                  <div style={{
                    ...
                    margin: "12px 0 6px", paddingLeft: 4,
                  }}>
                    {group}
                  </div>
                  {TABS.filter((t) => t.group === group).map((t) => (
                    <button
                      ...
                      style={{
                        ...
                        background: tab === t.id ? "var(--blue-glow, rgba(37,99,235,.1))" : "transparent",
            ...
            <div style={{ padding: "14px", borderTop: "1px solid var(--gray-100)", marginTop: "auto" }}>
              <div style={{ background: "linear-gradient(135deg,rgba(99,102,241,.12),rgba(139,92,246,.08))", borderRadius: 12, padding: "14px", border: "1px solid rgba(99,102,241,.15)" }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: "#6366f1", marginBottom: 5 }}>💡 Tip</div>
                <div style={{ fontSize: 12, color: "var(--gray-600)", lineHeight: 1.55 }}>Changes are saved to localStorage and update the live site immediately after clicking Save.</div>
              </div>
            </div>
          </aside>
        </>
        ...
        <main style={{ flex: 1, padding: "28px 32px", maxWidth: "860px", overflowX: "hidden" }}>
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 13, color: "var(--gray-400)" }}>
              Edit content below — click <strong style={{ color: "var(--navy)" }}>Save Changes</strong> to publish to the live site.
            </p>
          </div>
      ...
      {saved && <Toast msg="Changes saved successfully!" onClose={() => setSaved(false)} />}
